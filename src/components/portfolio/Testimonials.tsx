          ...
          >
            {visible.map((t, i) => (
              <motion.div
                ...
                className="p-8 md:p-10 rounded-xl md:rounded-2xl bg-white/5 border border-white/10 hover:bg-white/10 transition-colors group relative"
              >
                ...
                <div className="flex items-center gap-4 md:gap-6 relative z-10 pt-6 md:pt-8 border-t border-white/10">
                  {t.avatar ? (
                    <div className="w-12 h-12 md:w-14 md:h-14 rounded-lg overflow-hidden border-2 border-white/20 group-hover:border-white/50 transition-colors shrink-0">
                      <img src={t.avatar} alt={t.name} className="w-full h-full object-cover" />
                    </div>
                  ) : (
                    <div className="w-12 h-12 md:w-14 md:h-14 rounded-lg bg-white/10 border-2 border-white/20 flex items-center justify-center shrink-0">
        ...
        {totalPages > 1 && (
          <div className="flex items-center justify-center gap-4 mt-12">
            <button
              ...
              disabled={page === 0}
              className="p-3 rounded-lg border border-white/20 hover:bg-white/10 disabled:opacity-20 disabled:cursor-not-allowed transition-all"
            >
